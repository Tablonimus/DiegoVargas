      ...
      <div className="flex justify-center">
        <div className=" relative flex flex-col h-56 md:h-96 w-2/3  md:w-10/12 bg-white/80 p-2 rounded-lg ">
          <section className="flex flex-col gap-2 justify-between items-center h-full text-black py-2">
            ...
            <a href="https://www.instagram.com/suelaproducciones" target="_blank">
              <button className="py-2 px-6 rounded-lg border hover:bg-cyan-400 bg-cyan-500 text-white drop-shadow-2xl">
                Contacto
              </button>
            </a>
            <span className="text-center italic text-sm md:text-3xl font-bold">
